using ChristianHelle.Framework.WindowsMobile.Barcode.Scanners;

namespace ChristianHelle.Framework.WindowsMobile.Barcode
{
    /// <summary>
    ...
    /// and Symbol devices (<see cref="SymbolScanner"/>).
    /// 
            ...
            get
            {
                lock (syncLock)
                {
                    if (instance == null)
                    {
                        ...
                        MobileApplication.DispoableResources.Add("BarcodeScanner", instance);
                    }
                    return instance; 
                }
            }
